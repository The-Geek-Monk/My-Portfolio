  ...
  return (
    ...
    <AnimationContainer customClassName='w-[80px] sm:w-[176px] relative mb-6 lg:mb-0'>
      ...
      <AnimationContainer customClassName='flex flex-col items-center justify-between lg:items-start p-0 lg:pr-8'>
        <h1 style={{ 
    backgroundImage: 'linear-gradient(135deg, var(--colors-pink) 0%, var(--colors-purple) 100%)', 
    WebkitBackgroundClip: 'text', 
    WebkitTextFillColor: 'transparent'
  }}
   className='font-bold text-2xl lg:text-5xl text-center lg:text-start tracking-tight mb-3 text-white mx-auto lg:mx-0'>
          Hey, I'm Vasu Sehgal
        </h1>
