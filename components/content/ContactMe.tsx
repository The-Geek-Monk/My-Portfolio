    ...
    <AnimationContainer customClassName='w-[80%] flex justify-center'>
      ...
      <div className="flex flex-col items-center justify-between sm:flex-row w-full">
        <div 
          ...
          style={{ backgroundImage: 'linear-gradient(rgba(52, 211, 153, 0.8), rgba(52, 211, 153, 0.3))' }}
        >
          <div className="p-4 bg-gray-800">
            <div className="flex items-center">
              ...
              <div className="flex flex-col ml-4" style={{ maxWidth: '200px' }}>
        ...
        <div className="flex items-center justify-center mt-4 sm:mt-0 ml-2 gap-2 md:gap-4 md:ml-4">
          <a href="https://linkedin.com/in/samyakahuja" title="LinkedIn" target="_blank" rel="noopener noreferrer" className="inline-flex p-2 text-gray-600 dark:text-gray-400">
          ...
          <a href="https://github.com/samyakahuja" title="Github" target="_blank" rel="noopener noreferrer" className="inline-flex p-2 text-gray-600 dark:text-gray-400">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
